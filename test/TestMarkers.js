...
export class TestMarkers extends Test {
    testSetMarker() {
        ...
        setTimeout(() => {
            ...
            Test.assertEquals("markerCircle", chessboard.getMarkers("e5")[0].type.slice)
            Test.assertEquals(2, chessboard.getMarkers(undefined, MARKER_TYPE.emphasize).length)
            ...
            Test.assertEquals(1, chessboard.getMarkers(undefined, MARKER_TYPE.move).length)
